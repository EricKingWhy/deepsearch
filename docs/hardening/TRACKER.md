...
| `main` 当前 tip（2026-09-16 核实，本地＝远端） | `e4b4a08`（**§4 总门禁（第二轮）收口 PR #183 的 merge** —— 含 3 个 commit：`9911204`（test 假红修复）/ `d8f1821`（台账回填）/ `0eb74b5`（表格修复）；其前为 T56 PR #180 = `8588718`、T55 PR #178 = `1161a9e`、T54 PR #176 = `1013d53`、T53 PR #174 = `d5a0a9d`） |
...
| 当前 fixed point（上一批审查结束 commit） | `187cb90`（阶段 7 第 3 批审查修复 commit）。**§4 总门禁（第二轮）fixed point = 计划起始基线 `9342913`，审查终点 = `8588718`；本轮修复落在 `8588718`（台账记录于 `d8f1821`），收口 commit = `e4b4a08`（PR #183 的 merge）** |
